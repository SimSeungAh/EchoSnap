...
import com.smartrecycle.backend.domain.residence.entity.GeneralHousingType;
import com.smartrecycle.backend.domain.residence.entity.Residence;
import com.smartrecycle.backend.domain.residence.repository.ResidenceRepository;
...
public class ResidenceCollectionAreaMatchService {
  ...
  /**
   * SmartRecycle에서 MANAGED_COMPLEX로 처리하는
   * 명확한 관리형 주거 조건입니다.
   *
