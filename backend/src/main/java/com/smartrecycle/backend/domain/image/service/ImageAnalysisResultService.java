...
import com.smartrecycle.backend.domain.image.dto.response.ImageAnalysisResultResponse;
...
import com.smartrecycle.backend.domain.schedule.service.CollectionAreaScheduleQueryService;
...
/**
 * AI 분석 결과를 실제 SmartRecycle 서비스 정보와
 * 연결하는 Service입니다.
 *
