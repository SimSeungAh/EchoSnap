package com.smartrecycle.backend.domain.admin.controller;

import com.smartrecycle.backend.domain.admin.dto.AdminDashboardDtos;
import com.smartrecycle.backend.domain.admin.service.AdminDashboardService;
...
@Tag(
    ...
    description = "SmartRecycle 관리자 대시보드 API"
)
