package com.echosnap.backend.domain.publicdata.service;

import com.echosnap.backend.domain.collectionarea.dto.response.CollectionAreaSyncResultResponse;
import com.echosnap.backend.domain.collectionarea.service.CollectionAreaPublicDataSyncService;
import com.echosnap.backend.domain.publicdata.entity.PublicDataSyncLog;
import com.echosnap.backend.domain.publicdata.repository.PublicDataSyncLogRepository;
