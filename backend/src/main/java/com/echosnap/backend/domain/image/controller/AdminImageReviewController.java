...
import com.echosnap.backend.domain.image.dto.request.ApproveImageReviewRequest;
import com.echosnap.backend.domain.image.dto.request.RejectImageReviewRequest;
import com.echosnap.backend.domain.image.dto.response.AdminImageReviewResponse;
import com.echosnap.backend.domain.image.dto.response.ImageFileResponse;
import com.echosnap.backend.domain.image.service.AdminImageReviewService;
