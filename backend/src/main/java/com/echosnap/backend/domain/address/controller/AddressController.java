package com.echosnap.backend.domain.address.controller;

import com.echosnap.backend.domain.address.dto.response.AddressSearchResultResponse;
import com.echosnap.backend.domain.address.service.AddressSearchService;
...
public class AddressController {
  ...
  @Operation(
      ...
      description = """
                    도로명 또는 지번 주소를 검색합니다.
                    카카오 주소 검색 API 결과를 EchoSnap 내부 형식으로 변환해 반환합니다.
