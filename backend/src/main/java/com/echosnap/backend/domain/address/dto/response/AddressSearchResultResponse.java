package com.echosnap.backend.domain.address.dto.response;
...
/**
 * Flutter 사용자 앱에 반환하는 EchoSnap 내부 주소 검색 결과 DTO입니다.
 *
