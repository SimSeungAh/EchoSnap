...
class ScheduleExceptionInfo {
  ...
  factory ScheduleExceptionInfo.fromJson(
...
class GeneralHousingScheduleItem {
  ...
  final ScheduleExceptionInfo?
  todayException;

  factory GeneralHousingScheduleItem.fromJson(
      Map<String, dynamic> json,
      ) {
    final dynamic exceptionJson =
    json['todayException'];
    ...
    return GeneralHousingScheduleItem(
      ...
      is Map<String, dynamic>
          ? ScheduleExceptionInfo.fromJson(
        exceptionJson,
      )
          : null,
    );
...
class GeneralHousingScheduleData {
  ...
  final List<GeneralHousingScheduleItem>
  schedules;

  factory GeneralHousingScheduleData.fromJson(
      Map<String, dynamic> json,
      ) {
    ...
    return GeneralHousingScheduleData(
      ...
      administrativeDong:
      json['administrativeDong']
      as String?,
      legalDong:
      json['legalDong'] as String?,
      referenceDateTime:
      json['referenceDateTime']
          ?.toString(),
      schedules:
...
class ManagedScheduleTime {
  ...
  factory ManagedScheduleTime.fromJson(
      Map<String, dynamic> json,
      ) {
...
class ManagedScheduleItem {
  ...
  final List<ManagedScheduleTime>
  schedules;

  final ScheduleExceptionInfo?
  todayException;

  factory ManagedScheduleItem.fromJson(
      Map<String, dynamic> json,
      ) {
...
class ManagedComplexScheduleData {
  ...
  factory ManagedComplexScheduleData.fromJson(
      Map<String, dynamic> json,
      ) {
    final dynamic itemsJson =
    json['items'];

    return ManagedComplexScheduleData(
      apartmentName:
      json['apartmentName'] as String? ??
          '공동주택',
      referenceDateTime:
      json['referenceDateTime']
          ?.toString(),
...
class ScheduleApi {
  ...
  static Future<GeneralHousingScheduleData>
  getGeneralHousingSchedule() async {
    ...
    return GeneralHousingScheduleData.fromJson(
      data,
    );
  }

  static Future<ManagedComplexScheduleData>
  getManagedComplexSchedule() async {
    final Map<String, dynamic> body =
    await _get(
      '/api/schedules/me',
    );
    ...
    return ManagedComplexScheduleData.fromJson(
      data,
    );
  }
